...
const NotificationSections = () => {
  ...
  const {
    today = [],
    earlier = []
  } = useMemo(() => splitNotificationsByTime(notificationList), [notificationList]);
  ...
  const renderNotificationSection = (section, items) => {
    ...
    }, section === 'today' && intl.formatMessage(messages.notificationTodayHeading), section === 'earlier' && intl.formatMessage(messages.notificationEarlierHeading)), notificationList?.length > 0 && (section === 'earlier' ? today.length === 0 : true) && /*#__PURE__*/React.createElement(Button, {
      variant: "link",
      className: "small line-height-10 text-decoration-none p-0 border-0 text-info-500",
      onClick: handleMarkAllAsRead,
      size: "sm",
      "data-testid": "mark-all-read"
    }, intl.formatMessage(messages.notificationMarkAsRead))), items.map(notification => /*#__PURE__*/React.createElement(NotificationRowItem, {
      key: notification.id,
      id: notification.id,
  ...
  const shouldRenderEmptyNotifications = notificationList?.length === 0 && notificationListStatus === RequestStatus.SUCCESSFUL && notificationRef?.current && popoverHeaderRef?.current;
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, renderNotificationSection('today', today), renderNotificationSection('earlier', earlier), notificationListStatus === RequestStatus.IN_PROGRESS ? /*#__PURE__*/React.createElement("div", {
    className: "d-flex justify-content-center p-4"
  }, /*#__PURE__*/React.createElement(Spinner, {
    animation: "border",
    variant: "primary",
    size: "lg",
    "data-testid": "notifications-loading-spinner"
  })) : hasMorePages && notificationListStatus === RequestStatus.SUCCESSFUL && notificationList.length >= 10 && /*#__PURE__*/React.createElement(Button, {
    variant: "primary",
    className: "w-100 bg-primary-500 load-more-btn",
    onClick: loadMoreNotifications,
    "data-testid": "load-more-notifications"
  }, intl.formatMessage(messages.loadMoreNotifications)), notificationList.length > 0 && !hasMorePages && notificationListStatus === RequestStatus.SUCCESSFUL && /*#__PURE__*/React.createElement("div", {
    className: "d-flex flex-column my-5",
    "data-testid": "notifications-list-complete"
  }, /*#__PURE__*/React.createElement(Icon, {
    className: "mx-auto icon-size-56",
    src: CheckCircleLightOutline
  }), /*#__PURE__*/React.createElement("div", {
    className: "mx-auto mb-3  mt-3.5 lead notification-end-title line-height-24"
  }, intl.formatMessage(messages.allRecentNotificationsMessage)), /*#__PURE__*/React.createElement("div", {
    className: "d-flex flex-row mx-auto text-gray-500"
  }, /*#__PURE__*/React.createElement(Icon, {
    src: AutoAwesome
  }), /*#__PURE__*/React.createElement("span", {
    className: "small line-height-normal"
  }, intl.formatMessage(messages.expiredNotificationsDeleteMessage, {
    days: notificationExpiryDays
  })))), shouldRenderEmptyNotifications && /*#__PURE__*/React.createElement(NotificationEmptySection, null));
};
